    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog_type', models.CharField(choices=[('news', 'News'), ('blog', 'Blog'), ('deals', 'Deals')], default='blog', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(blank=True, choices=[('U', 'Used'), ('N', 'New')], default='N', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('coverpage_center', 'Coverpage Center'), ('banner_right', 'Banner Right'), ('banner_left', 'Banner Left'), ('coverpage_bottom', 'Coverpage Bottom'), ('coverpage_top', 'Coverpage Top')], default='coverpage_top', max_length=100)),
                ('active', models.BooleanField()),
